<template>
    <AppLayout>
        ...
        <div :class="{ 'blur-md pointer-events-none select-none transition-all duration-300': showClaimOverlay }">
                            ...
                            <va-dropdown-content class="p-0">
                                <va-list>
                                    ...
                                    <template v-if="isAssignedSupporter">
                                        <va-list-item @click="updateStatus('open')" class="cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700">
                                            <va-list-item-section>Re-Open Ticket</va-list-item-section>
                                        </va-list-item>
                                        <va-list-item @click="updateStatus('in_progress')" class="cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700">
                                            <va-list-item-section>Set In Progress</va-list-item-section>
                                        </va-list-item>
                                        <va-list-item @click="updateStatus('resolved')" class="cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700">
                                            <va-list-item-section class="text-blue-600 dark:text-blue-400">Mark Resolved</va-list-item-section>
                                        </va-list-item>
                                        <va-list-item @click="updateStatus('closed')" class="cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700">
                                            <va-list-item-section class="text-red-600 dark:text-red-400">Close Ticket</va-list-item-section>
                                        </va-list-item>
            ...
            <div class="chat-container flex flex-col bg-gray-100 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden h-[600px]">
                ...
                <div class="flex-1 overflow-y-auto p-6" ref="messagesContainer">
                    <div v-if="localMessages.length === 0" class="text-center text-gray-500 dark:text-gray-400 py-10">
                        No messages yet.
                    </div>
